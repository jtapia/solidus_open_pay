...
ActiveRecord::Schema[7.2].define(version: 2024_11_23_051179) do
  ...
  create_table "open_pay_sources", force: :cascade do |t|
  ...
  create_table "spree_open_pay_payments", force: :cascade do |t|
    t.string "type"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
